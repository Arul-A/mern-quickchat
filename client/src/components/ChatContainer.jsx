...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-xl'>
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center p-3 gap-3'>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          ...
          />
          <input onChange={handleSendImage} type='file' id='image' accept='image/png, image/jpeg' hidden className='' />
          <label htmlFor='image'>
    ...
    <div className='flex items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden'>
